...
' Principal
'***********
Set oCnd=CreateObject("Vision.Application")
Set oFSO=CreateObject("Scripting.FileSystemObject")
sPth="C:\_Clientes\Coprocafe\D6DEC\www\"
nErr=chkErr("[CreateObject]")

qsA="V" 'Request.QueryString("A")
If qsA="C" Then sRpt="CONTRATO Compra" else sRpt="CONTRATO Venta"
qsC="5252502" '"5251401" 'Request.QueryString("C")
qsN="PRUEBA_VBS.pdf" 'Request.QueryString("N")
...
nErr=chkErr("[Parameter: p_CTTO=" & qsC & "]")
...
oPI.FromPage = 1
oPI.ToPage = -1	 '(all)
oPI.OutFileName = sPth & "pdf\pruebas_vbs\" & qsN		
